#include "texturewater.h"

WaterTexture::WaterTexture() {
}

WaterTexture::WaterTexture(int width, int height) {
}

void WaterTexture::drawTextureImageToFiles(std::string planeImg, std::string planarImg, std::string sphereImg) {
...
void WaterTexture::CreateTextureColor(utils::RendererImage &renderer) {
    renderer.ClearGradient();
	renderer.AddGradientPoint(-1.00, utils::Color(118, 134, 192, 255));
	renderer.AddGradientPoint(0.50, utils::Color(144, 148, 172, 255));
	renderer.AddGradientPoint(1.00, utils::Color(132, 110, 216, 255));
}

void WaterTexture::CreatePlanarTexture(const module::Module &noiseModule, bool seamless,
...
void WaterTexture::CreateSphericalTexture(const module::Module &noiseModule, int height,
		const char *filename) {
...
void WaterTexture::RenderTexture(const utils::NoiseMap &noiseMap, const char *filename) {
